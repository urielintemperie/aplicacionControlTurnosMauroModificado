...
def nuevoTurno(request, doc, dia):
    ...
    print(datetime.datetime.strptime(dia, '%Y-%m-%d').date().weekday())
    #doc_horario = getattr(doctor, 'horario')
    ...
    for horario in doc_horario:
        print('horario del for')
        print (horario)
        doc_inicio = getattr(horario, 'horaInicio')
        print('doc_inicio')
        print(doc_inicio)
        #print ('doc_inicio en datetime')
        #diayhora = datetime.datetime.combine(datetime.date(2017, 01, 01), doc_inicio) 
        #diaYHora=datetime.datetime.combine(datetime.date(2011, 01, 01), datetime.time(10, 23))
        #print ( diayhora)
        #print ('doc_inicio en segundos')
        #print((t-doc_inicio).total_seconds())
